...
class PersonalDetailsControllerSpec extends PlaySpecification {
...
//    }
//
//    "error when no firstName is not provided" in {
//      MyForms.personalDetailsForm.bind(personalDetails + ("firstName" -> "")).fold(
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe("First Name is mandatory")
...
//    }
//
//    "error when no lastName is not provided" in {
//      MyForms.personalDetailsForm.bind(personalDetails + ("lastName" -> "")).fold(
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe("Last Name is mandatory")
//          formWithErrors.errors.length shouldBe (1)
//        },
...
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe ("error.number")
//          formWithErrors.errors.length shouldBe (1)
//        },
...
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe("The day is mandatory")
//          formWithErrors.errors.length shouldBe (1)
//        },
...
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe("The month is mandatory")
//          formWithErrors.errors.length shouldBe (1)
//        },
...
//        formWithErrors => formWithErrors.errors.head.message shouldBe("Not a valid date"),
//        success => {
...
//        formWithErrors => {
//          formWithErrors.errors.head.message shouldBe("Not a valid date")
//        },
//        success => {
//          fail("Error, a leap year date has been allowed to be passed into the form")
//        }
